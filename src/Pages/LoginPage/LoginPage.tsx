		...
		<div className={styles.wrapper}>
			<div className={styles.element}>
				<figure className={styles.logo}>
					...
					<figcaption>
						<Text
							userColor={'red'}
							userStyle={'fat_extraBig'}
							text={language.ELanguageKey.METEOR}
						/>
					</figcaption>
				</figure>
			</div>
				...
				<div className={styles.main}>
					<div className={styles.title}>
						<div>
							<Text
								userStyle={'fat_extraBig'}
								text={language.ELanguageKey.SING_INING}
							/>
						</div>
						<div>
							<Text
								userColor={'skyblue'}
								text={language.ELanguageKey.OR_CREATE_ACC}
							/>
						</div>
					</div>
					<div>
			...
			<div className={styles.element}>
				<div className={styles.footer}>
					<Text userStyle={'fat_small'} text={language.ELanguageKey.COPYRIGHT} />
				</div>
			</div>
		</div>
	);
