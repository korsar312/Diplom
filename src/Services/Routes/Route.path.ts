...
const PersonPage = lazy(() => import("../../Pages/CooperatorPage/CooperatorPage"));
const ChatPage = lazy(() => import("../../Pages/AboutPage/AboutPage"));
const ManagementPage = lazy(() => import("../../Pages/ErrorPage/ErrorPage"));
const CompaniesPage = lazy(() => import("../../Pages/MainPage/MainPage"));
const ImportProductPage = lazy(() => import("../../Pages/AboutPage/AboutPage"));
const ExportProductPage = lazy(() => import("../../Pages/ErrorPage/ErrorPage"));
const SuppliesPage = lazy(() => import("../../Pages/ErrorPage/ErrorPage"));
const WarehousePage = lazy(() => import("../../Pages/ErrorPage/ErrorPage"));
const RequestPage = lazy(() => import("../../Pages/ErrorPage/ErrorPage"));
const ReportPage = lazy(() => import("../../Pages/ErrorPage/ErrorPage"));
